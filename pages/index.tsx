  ...
  return (
    <>
          ...
          <div className="trust-inner">
            ...
            <div className="trust-card">
              ...
              <div className="trust-body">
                ...
                <p>
                  Solicita tu teleconsulta a cualquier hora, todos los días. Siempre hay voluntarios
      ...
      <style jsx>{`
        ...
        .hero {
          background:
            radial-gradient(1200px 500px at 80% -10%, rgba(245, 196, 0, 0.18), transparent 60%),
